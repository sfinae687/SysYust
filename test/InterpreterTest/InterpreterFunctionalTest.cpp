...
TEST(InterpreterTest, FunctinoalTest2) {
    using namespace SysYust::AST;
    ...
    auto gvar1No = tree.pushNode();
    auto gvar1Id = currentEnv->getId("a");
    VarInfo gvar1Info("a", &Int_v, gvar1No);

    auto gvar2No = tree.pushNode();
    auto gvar2Id = currentEnv->getId("b");
    VarInfo gvar2Info("b", &Int_v, gvar1No);
